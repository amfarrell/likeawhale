...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column('articles_translation', 'dest_lang_id', 'target_language_id')

        db.rename_column('articles_article', 'source_lang_id', 'native_language_id')

    def backwards(self, orm):

        db.rename_column('articles_translation', 'target_language_id', 'dest_lang_id')

        db.rename_column('articles_article', 'native_language_id', 'source_lang_id')
