...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('articles_word', 'difficulty',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('articles_word', 'difficulty')
    ...
    models = {
        ...
        'articles.userwordknowledge': {
            'Meta': {'object_name': 'UserWordKnowledge'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mastery_level': ('django.db.models.fields.IntegerField', [], {}),
            'view_count': ('django.db.models.fields.IntegerField', [], {}),
            'word': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'word_id': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['articles.Word']"})
        },
        'articles.word': {
