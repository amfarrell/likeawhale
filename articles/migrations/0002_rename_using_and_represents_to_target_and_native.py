...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column('articles_translatedphrase', 'represents_first_id', 'first_target_id')

        db.rename_column('articles_translatedphrase', 'represents_second_id', 'second_target_id')

        db.rename_column('articles_translatedphrase', 'represents_third_id', 'third_target_id')

        db.rename_column('articles_translatedphrase', 'using_first_id', 'first_native_id')

        db.rename_column('articles_translatedphrase', 'using_second_id', 'second_native_id')

        db.rename_column('articles_translatedphrase', 'using_third_id', 'third_native_id')


    def backwards(self, orm):
        db.rename_column('articles_translatedphrase', 'first_target_id', 'represents_first_id')

        db.rename_column('articles_translatedphrase', 'first_target_id', 'represents_second_id')

        db.rename_column('articles_translatedphrase', 'first_target_id', 'represents_third_id')

        db.rename_column('articles_translatedphrase', 'first_native_id', 'using_first_id')

        db.rename_column('articles_translatedphrase', 'first_native_id', 'using_second_id')

        db.rename_column('articles_translatedphrase', 'first_native_id', 'using_third_id')
