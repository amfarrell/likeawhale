...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LayoutElement._order'
        db.add_column('articles_layoutelement', '_order',
        ...
        # Adding field 'PhraseInTranslation._order'
        db.add_column('articles_phraseintranslation', '_order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'LayoutElement._order'
        db.delete_column('articles_layoutelement', '_order')

        # Deleting field 'PhraseInTranslation._order'
        db.delete_column('articles_phraseintranslation', '_order')
