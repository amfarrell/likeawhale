...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('articles_phraseintranslation', 'end_punctuation', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'PhraseInTranslation.start_punctuation'
        db.alter_column('articles_phraseintranslation', 'start_punctuation', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'Stem.native_text'
        db.alter_column('articles_stem', 'native_text', self.gf('django.db.models.fields.CharField')(max_length=256))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Stem.native_text'
        db.alter_column('articles_stem', 'native_text', self.gf('django.db.models.fields.CharField')(max_length=124))
