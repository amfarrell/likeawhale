...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('articles_article', 'slug', self.gf('django.db.models.fields.CharField')(max_length=124, unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'Article.slug'
        db.alter_column('articles_article', 'slug', self.gf('django.db.models.fields.CharField')(default='unknown', max_length=124, unique=True))
    ...
    models = {
        'articles.article': {
            ...
            'slug': ('django.db.models.fields.CharField', [], {'max_length': '124', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
