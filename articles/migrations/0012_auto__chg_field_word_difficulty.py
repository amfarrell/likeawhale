...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Word.difficulty'
        db.alter_column('articles_word', 'difficulty', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Word.difficulty'
        db.alter_column('articles_word', 'difficulty', self.gf('django.db.models.fields.IntegerField')(default=-1))
