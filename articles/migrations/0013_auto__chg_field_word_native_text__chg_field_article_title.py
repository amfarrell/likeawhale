...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('articles_article', 'title', self.gf('django.db.models.fields.CharField')(unique=True, max_length=256))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Article.title'
        db.alter_column('articles_article', 'title', self.gf('django.db.models.fields.CharField')(max_length=124, unique=True))
    ...
    models = {
        ...
        'articles.word': {
            ...
            'native_text': ('django.db.models.fields.CharField', [], {'max_length': '248'})
        }
    }
