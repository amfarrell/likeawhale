...
if 'UAP_DB_NAME' not in os.environ:
  raise Exception("you need to run `workflow_uap` which will define the name of the database to use")

DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql_psycopg2', # Add 'postgresql_psycopg2', 'mysql', 'sqlite3' or 'oracle'.
        'NAME': os.environ['UAP_DB_NAME'],                              # Or path to database file if using sqlite3.
        'USER': os.environ['UAP_DB_USER'],                                     # Not used with sqlite3.
        'PASSWORD': os.environ['UAP_DB_PASSWORD'],                  # Not used with sqlite3.
        'HOST': os.environ.get('UAP_DB_HOST','localhost'),                      # Set to empty string for localhost. Not used with sqlite3.
        'PORT': os.environ.get('UAP_DB_PORT',''),                      # Set to empty string for default. Not used with sqlite3.
    }
}
